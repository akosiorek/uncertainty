...
class UncertaintyLossParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_uncertainty_loss_param() const;
  inline void clear_uncertainty_loss_param();
  static const int kUncertaintyLossParamFieldNumber = 138;
  inline const ::caffe::UncertaintyLossParameter& uncertainty_loss_param() const;
  inline ::caffe::UncertaintyLossParameter* mutable_uncertainty_loss_param();
  inline ::caffe::UncertaintyLossParameter* release_uncertainty_loss_param();
  inline void set_allocated_uncertainty_loss_param(::caffe::UncertaintyLossParameter* uncertainty_loss_param);
 ...
 private:
  ...
  inline void set_has_uncertainty_loss_param();
  inline void clear_has_uncertainty_loss_param();
  ...
  ::caffe::UncertaintyLossParameter* uncertainty_loss_param_;
...
class UncertaintyLossParameter : public ::google::protobuf::Message {
 public:
  UncertaintyLossParameter();
  virtual ~UncertaintyLossParameter();

  UncertaintyLossParameter(const UncertaintyLossParameter& from);

  inline UncertaintyLossParameter& operator=(const UncertaintyLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const UncertaintyLossParameter& default_instance();

  void Swap(UncertaintyLossParameter* other);

  // implements Message ----------------------------------------------

  UncertaintyLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const UncertaintyLossParameter& from);
  void MergeFrom(const UncertaintyLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_uncertainty_weight() const;
  inline void clear_uncertainty_weight();
  static const int kUncertaintyWeightFieldNumber = 1;
  inline float uncertainty_weight() const;
  inline void set_uncertainty_weight(float value);

  // @@protoc_insertion_point(class_scope:caffe.UncertaintyLossParameter)
 private:
  inline void set_has_uncertainty_weight();
  inline void clear_has_uncertainty_weight();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  float uncertainty_weight_;
  ...
  void InitAsDefaultInstance();
  static UncertaintyLossParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.UncertaintyLossParameter uncertainty_loss_param = 138;
inline bool LayerParameter::has_uncertainty_loss_param() const {
  return (_has_bits_[1] & 0x00008000u) != 0;
}
inline void LayerParameter::set_has_uncertainty_loss_param() {
  _has_bits_[1] |= 0x00008000u;
}
inline void LayerParameter::clear_has_uncertainty_loss_param() {
  _has_bits_[1] &= ~0x00008000u;
}
inline void LayerParameter::clear_uncertainty_loss_param() {
  if (uncertainty_loss_param_ != NULL) uncertainty_loss_param_->::caffe::UncertaintyLossParameter::Clear();
  clear_has_uncertainty_loss_param();
}
inline const ::caffe::UncertaintyLossParameter& LayerParameter::uncertainty_loss_param() const {
  return uncertainty_loss_param_ != NULL ? *uncertainty_loss_param_ : *default_instance_->uncertainty_loss_param_;
}
inline ::caffe::UncertaintyLossParameter* LayerParameter::mutable_uncertainty_loss_param() {
  set_has_uncertainty_loss_param();
  if (uncertainty_loss_param_ == NULL) uncertainty_loss_param_ = new ::caffe::UncertaintyLossParameter;
  return uncertainty_loss_param_;
}
inline ::caffe::UncertaintyLossParameter* LayerParameter::release_uncertainty_loss_param() {
  clear_has_uncertainty_loss_param();
  ::caffe::UncertaintyLossParameter* temp = uncertainty_loss_param_;
  uncertainty_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_uncertainty_loss_param(::caffe::UncertaintyLossParameter* uncertainty_loss_param) {
  delete uncertainty_loss_param_;
  uncertainty_loss_param_ = uncertainty_loss_param;
  if (uncertainty_loss_param) {
    set_has_uncertainty_loss_param();
  } else {
    clear_has_uncertainty_loss_param();
  }
...
// optional float uncertainty_weight = 1 [default = 1];
inline bool UncertaintyLossParameter::has_uncertainty_weight() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void UncertaintyLossParameter::set_has_uncertainty_weight() {
  _has_bits_[0] |= 0x00000001u;
}
inline void UncertaintyLossParameter::clear_has_uncertainty_weight() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void UncertaintyLossParameter::clear_uncertainty_weight() {
  uncertainty_weight_ = 1;
  clear_has_uncertainty_weight();
}
inline float UncertaintyLossParameter::uncertainty_weight() const {
  return uncertainty_weight_;
}
inline void UncertaintyLossParameter::set_uncertainty_weight(float value) {
  set_has_uncertainty_weight();
  uncertainty_weight_ = value;
}
