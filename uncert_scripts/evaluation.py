...
MODEL_FILE = 'deploy2.prototxt'
# PRETRAINED = 'snapshot/snapshot_iter_1000.caffemodel'
...
def perform_tests(PRETRAINED):
    net = caffe.Net(MODEL_FILE, PRETRAINED, caffe.TEST)  # image_dims=(28, 28))
    ...
    with env.begin() as txn:
        ...
        for key, raw_datum in cursor:
            ...
            uncertainty = net.blobs["uncertainty"].data
